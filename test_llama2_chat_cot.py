...
def main(args):
    prompt = "Generate the response using the pipeline of emotion, cause emotion, emotion stimulus, individual appraisal, recogized strategy, strategy reason and response of supporter."
